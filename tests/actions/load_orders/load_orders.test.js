...
import { fetchData } from '../../../src/actions/orders/ordersLoadAction'; 
import { FETCH_DATA_REQUEST, FETCH_DATA_SUCCESS, FETCH_DATA_FAILURE } from '../../../src/actions/orders/ordersLoadActionTypes';
...
describe('fetchData actions', () => { //Tempo de montagem 04 min e 31 seg 
  let store;
  ...
  it('should dispatch FETCH_DATA_REQUEST and FETCH_DATA_SUCCESS when fetching data is successful', async () => {
    ...
    const fakeUrl = 'http://fakeurl.com/api/pedido/get-all-bean';
